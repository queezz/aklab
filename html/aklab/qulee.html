...
<dd>
<div class="desc"><p>Provided dir, reads all converted Quelee *.csv's and plots into a PDF
ls: list of absolute paths to files to plot
OR
dir: directory to scan and plot
out: output pdf file name or absolute path
...
anchor= kws.get('anhcor',[1,1])
rasterized = kws.get('rasterized',True)
ylim = kws.get('ylim',[1e-14,1e-5])</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Class for reading, processing, and storing Qulee QMS data</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
<pre><code class="python">class QMS:
    ...
    def plot(self, **kws):
        ...
        ax.legend(loc=1, bbox_to_anchor=[1, 1])</code></pre>
</details>
<h3>Methods</h3>
<dl>
...
<dd>
<div class="desc"><p>Return qms data with proper datetime column for time
1. parse header using qms_file_parser
2. read csv file
Convert time
3. convert qms time format from '000:00:00.00' to
a) seconds and append to dataframe, and
b) proper datetime object with correct time and date</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>plot time traces
kws:
masslist: specify list of masses to plot. Plots all by default.
from: starting time, self.start by default.
to: ending time, self.end by default
ylim: axis ylims
gridalpha: transparancy of the grid lines</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
